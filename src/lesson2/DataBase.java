...
public class DataBase {
    ...
    public void selectTable4(String table_name) throws ClassNotFoundException, SQLException {
        Statement statement = getDbConnection().createStatement();
    ...
    public void selectTable3(String table_name) throws ClassNotFoundException, SQLException {
        Statement statement = getDbConnection().createStatement();
        ResultSet resultSet = statement.executeQuery("SELECT * from " + table_name);
        while (resultSet.next()) {
            String line_1 = resultSet.getString(1);
